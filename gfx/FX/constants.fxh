...
// ------------------    Light          -------------------------
// --------------------------------------------------------------
static const float NIGHT_AMBIENT_BOOST = 1.0f; // 3.0 can just be baked into the below later ye?
...
// Fog of war
static const float 	FOW_MAX 					= 0.01f; //0.5
...
static const float BORDER_NIGHT_DESATURATION_MAX = 0.5f; // 0.2f how much border colors can get desaturated at night. 1.0f is full grey
