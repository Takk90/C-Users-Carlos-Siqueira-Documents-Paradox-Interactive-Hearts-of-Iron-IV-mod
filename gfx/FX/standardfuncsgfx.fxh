...
PixelShader = 
{
	...
	static const float FEATHER_MIN = -0.01f; //0.01
	static const float FEATHER_MAX = 0.01f; //0.01
	static const float MOON_FEATHER_MIN = -0.01f;
	static const float MOON_FEATHER_MAX = 0.01;
	static const float NIGHT_OPACITY = 0.90f; //0.85
	static const float NIGHT_DARKNESS = 0.3f; //0.5
