...
NGraphics = {
	...
	CITY_SPRAWL_AMOUNT = 20.0, 						-- Size of cities, higher gives larger cities #3
	...
	GRADIENT_BORDERS_THICKNESS_COUNTRY_LOW = 10.0, -- thickness in pixels -- 5
	GRADIENT_BORDERS_COUNTRY_CENTER_THICKNESS = 1.0, -- The center gradient is linear 1/255 per pixel for this many pixels --2
	...
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {180, 470, 1000},  -- At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {180, 470, 1000}, -- At what distance VPs are hidden
	AIRBASE_ICON_DISTANCE_CUTOFF = 900, -- At what distance air bases are hidden
	NAVALBASE_ICON_DISTANCE_CUTOFF = 900, -- At what distance naval bases are hi
	...
	MAP_ICONS_STRATEGIC_GROUP_CAM_DISTANCE = 500, -- second camera distance at which the icons begin to group up
	...
	COUNTRY_COLOR_SATURATION_MODIFIER = 0.8, -- 0.6
	COUNTRY_COLOR_BRIGHTNESS_MODIFIER = 1.0, -- 0.8
