...
NGraphics = {
	...
	ROOT_FRONT_MAX_INTERSECTION_TESTS_FRONT = 20,		-- 30 How many points before the current one to check for intersections against (optimization)
	ROOT_FRONT_MAX_INTERSECTION_TESTS_ORDER = 15,		-- 25 How many points before the current one to check for intersections against (optimization)
	...
	MIN_HDR_ADJUSTMENT = 0.6,     --0.18 0.5  är hur mkt den anpassar sig till mörka områden, mindre värde -> mer mörkerseen
	...
	COUNTRY_COLOR_BRIGHTNESS_MODIFIER = 0.7, -- 0.8
