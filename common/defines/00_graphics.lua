...
NGraphics = {
	...
	CITY_SPRAWL_AMOUNT = 3.0, 						-- Size of cities, higher gives larger cities #50
	...
	ROOT_FRONT_MAX_INTERSECTION_TESTS_FRONT = 30,		-- 30 How many points before the current one to check for intersections against (optimization)
	ROOT_FRONT_MAX_INTERSECTION_TESTS_ORDER = 25,		-- 25 How many points before the current one to check for intersections against (optimization)
	...
	DRAW_SHADOWS_CUTOFF = 400, --400
	DRAW_SHADOWS_FADE_LENGTH = 50, --50
	DRAW_FOW_CUTOFF = 400,
	...
	GRADIENT_BORDERS_THICKNESS_STATE = 11.0, --11
	GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_A = 2.0, --2
	GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_B = 20.0, --20
	GRADIENT_BORDERS_THICKNESS_STRATEGIC_REGIONS = 150.0, --20
	...
	MAPICON_GROUP_PASSES = 20, -- 20 how many mapicons get processed per frame for grouping. more = quicker response, fewer = better performance
	...
	POSTEFFECT_PER_PROVINCE_MIN_SNOW = 0.1, -- 0.1
	...
	EMISSIVE_BLOOM_STRENGTH = 1.0, --1.0
	...
	TONE_MAP_MIDDLE_GREY = 0.5, --0.7 was 0.5
	...
	COUNTRY_COLOR_SATURATION_MODIFIER = 0.6, -- 0.6
