...
NGraphics = {
	...
	CITY_SPRAWL_AMOUNT = 50.0, 						-- Size of cities, higher gives larger cities #3
	...
	MIN_HDR_ADJUSTMENT = 0.8,     --0.18 0.5  är hur mkt den anpassar sig till mörka områden, mindre värde -> mer mörkerseen
	...
	POLITICAL_GRID_SMALL_BOX_LIMIT = 7,              	-- Limit for gridbox in political view before it will be replaced with extended gridbox
