...
NCountry = {
	...
	INTERPOLATED_FRONT_STEPS_SHORT = 2,				-- Performance optimization - The amount of steps for interpolated fronts. Non-AI countries got full interpolated fronts, the rest has optimized version of it. #test
...
NProduction = {
	...
	EQUIPMENT_BASE_LEND_LEASE_WEIGHT = 0.02, -- Base equipment lend lease weight
...
NMilitary = {
	...
	LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 4,   -- extra damage dice if our armor outclasses enemy #6
...
NAI = {
	...
	RESEARCH_NEW_WEIGHT_FACTOR = 0.6, 			-- Impact of previously unexplored tech weights. Higher means more random exploration.
	...
	RESEARCH_BASE_DAYS = 620,					-- AI adds a base number of days when weighting completion time for techs to ensure it doesn't only research quick techs
