...
NDiplomacy = {
	...
	TENSION_STATE_VALUE = 4,						-- Tension value gained by annexing one state #10
	TENSION_CIVIL_WAR_IMPACT = 0.4,					-- civil war multiplier on tension.		--0.2
	TENSION_NO_CB_WAR = 15,							-- Amount of tension generated by a no-CB war #30
	TENSION_CB_WAR = 8,							-- Amount of tension generated by a war with a CB #15
	...
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.5,			-- Amount of tension generated for each sent division --0.5
	TENSION_DECAY = 0.5,							-- Each months tension decays this much	--0.07
