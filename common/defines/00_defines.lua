...
NDiplomacy = {
	...
	BASE_PEACE_LIBERATE_FACTOR = 1,				-- Base factor for liberate in %. #100
...
NMilitary = {
	...
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_AREA = 50.0,   -- Used when calculating the calue of defense area in the battle plan system #50
...
NAI = {
	...
	STR_UNIT_WEAK = 0.3,						-- Strength (equipment) % for unit to be considered weak
