...
NAir = {
	...
	NAVAL_STRIKE_DETECTION_BALANCE_FACTOR = 9.8,		-- Value used to scale the surface_visibility stats to balance the gameplay, so 100% detection chance still won't spam the strikes.
