...
NCountry = {
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.001,  -- accessible recruitable factor base --0.02
...
NMilitary = {
	...
	COMBAT_MOVEMENT_SPEED = 0.50,	               -- MD4 was 0.33 speed reduction base modifier in combat
	...
	ADDITIONAL_COMBAT_WIDTH = 40,                  -- more opened up by support attack --60
	...
	RIVER_CROSSING_SPEED_PENALTY_LARGE = -0.45,     -- large river crossing
	...
	ENEMY_AIR_SUPERIORITY_SPEED_IMPACT = -0.45,     -- effect on speed due to enemy air superiority
	...
	SLOWEST_SPEED = 10,								-- Default speed of units if no speed is defined
...
NNavy = {
	...
	AMPHIBIOUS_LANDING_PENALTY = -0.3,								-- amphibious landing penalty
