...
NMilitary = {
	...
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.15,        -- global damage modifier
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 1.1,	 	       -- % of equipment lost to strength ratio in combat, so some % is returned if below 1
