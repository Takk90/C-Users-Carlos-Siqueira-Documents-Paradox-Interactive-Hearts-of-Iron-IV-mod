...
NProduction = {
	...
	BASE_CONSUMER_GOODS_NEED_FACTOR = 5,  -- 50 Base factor for the consumer goods need of civilian factories in %.
...
NMilitary = {
	...
	REINFORCE_CHANCE = 0.2,                 	   -- base chance to join combat from back line when empty #0.02
	...
	RETREAT_SPEED_FACTOR = 0.75,                    -- speed bonus when retreating #0.25
...
NAI = {
	...
	DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 30,	-- Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
