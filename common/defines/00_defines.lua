...
NMilitary = {
	...
	SLOWEST_SPEED = 3,								-- Default speed of units if no speed is defined
...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 5.5,					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
	NAVAL_STRIKE_DAMAGE_TO_ORG = 5.0,					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Organisation reduction.
