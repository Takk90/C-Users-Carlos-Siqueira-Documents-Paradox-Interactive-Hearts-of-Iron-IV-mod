...
NDiplomacy = {
	...
	VOLUNTEERS_RETURN_EQUIPMENT = 0.85,				-- Returning volunteers keep this much equipment
...
NAI = {
	...
	DIPLOMACY_CREATE_FACTION_FACTOR = 1.0,		-- Factor for AI desire to create a new faction. Val < 1.0 makes it less likely to create than to join. #0.75
	...
	DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 20,	-- Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology #30
