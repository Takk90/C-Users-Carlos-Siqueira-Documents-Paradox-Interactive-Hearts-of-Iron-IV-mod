...
NAir = {
	...
	NAVAL_STRIKE_TARGETTING_TO_AMOUNT = 0.9,			-- MD4 was 0.3 Balancing value to convert the naval_strike_targetting equipment stats to chances of how many airplanes managed to do successfull strike.
...
NAI = {
	...
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 0.8, 	-- How willing major powers are to send volunteers.
	...
	BASE_DISTANCE_TO_CARE = 300.0,				-- Countries that are too far away are less interesting in diplomacy #600
	...
	LAND_DEFENSE_MIN_FACTORIES_FOR_AIR_IMPORTANCE = 10,	-- If amount of factories is less importance of factories won't apply
