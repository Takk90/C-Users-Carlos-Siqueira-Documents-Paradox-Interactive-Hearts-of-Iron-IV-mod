...
NDiplomacy = {
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 0.5, 	-- Daily pp cost for boost party popularity #0.25
	...
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.10,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
...
NMilitary = {
	...
	ADDITIONAL_COMBAT_WIDTH = 30,                  -- more opened up by support attack --60
...
NAI = {
	...
	DIPLOMACY_STAGE_COUP_COST_FACTOR = 1.0,	-- Desire to stage a coup subtracts the cost multiplied by this #100 (test)
