	...
	NDefines.NAir.ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.04 -- 0.1
	NDefines.NAir.ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.075 -- 0.1
	...
	NDefines.NNavy.ANTI_AIR_TARGETTING_TO_CHANCE = 0.04 -- 0.07
	NDefines.NNavy.ANTI_AIR_ATTACK_TO_AMOUNT = 0.005 -- 0.005
