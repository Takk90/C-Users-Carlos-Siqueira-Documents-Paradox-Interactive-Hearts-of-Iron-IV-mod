	...
	NDefines.NGraphics.STRATEGIC_AIR_COLOR_BAD = {0.8, 0, 0, 1}
	NDefines.NGraphics.STRATEGIC_AIR_COLOR_GOOD = {0, 0.8, 0, 1}
	NDefines.NGraphics.STRATEGIC_AIR_COLOR_AVERAGE = {0.8, 0.8, 0, 1}
	NDefines.NGraphics.STRATEGIC_AIR_COLOR_NEUTRAL = {165.0/255, 165.0/255, 165.0/255, 1} -- {140.0/255, 131.0/255, 119.0/255, 1}
	NDefines.NGraphics.STRATEGIC_NAVY_COLOR_MISSION = {0.9, 0.6, 0.0, 0}
