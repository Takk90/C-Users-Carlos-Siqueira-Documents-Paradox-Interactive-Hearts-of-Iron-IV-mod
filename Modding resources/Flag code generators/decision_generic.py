#Don't replace existing decisions, some are modified (e.g. DRC)
TAG_LIST = {"AFG","AGL","ALG","ARG","ARM","AST","AUS","AZE","BAN","BEL","BLR","BOL","BOS","BOT","BRA","BRM","BUL","CAM","CAN","CAR","CBD","CDI","CHA","CHI","CHL","CNG","COL","CRO","CZE",
            "DEN","DRC","ECU","EGU","EGY","ENG","ERI","EST","ETH","FIN","FRA","GAB","GAH","GEO","GER","GRE","HOL","IND","IRE","IRQ","ISR","ITA","JAP","KAZ","KEN","KOR","KYR","LAO","LAT",
            "LBA","LEB","LIB","LIT","MAD","MAL","MAU","MAY","MEX","MLV","MLW","MOR","MOZ","NAM","NEP","NGR","NIG","NKO","NOR","PAK","PER","PHI","POL","POR","PRU","RAJ","ROM","SAF","SAU",
            "SER","SIA","SOV","SWE","SWI","SYR","UKR","USA"}
